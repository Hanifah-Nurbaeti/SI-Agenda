...
class undangan extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('karyawan/undangan-view.php',$data);
    }  
    public function add($id_undangan=NULL){
        ...
        if ($submit){
            ...
            if ($this->form_validation->run()==FALSE){
                ...
                $this->Mundangan->setData($a,$b,$c,$d,$e,$f,$g,$h,$i);
                if ($j){
                    //Simpan Edit Data
        ...
        //jika membawa ID, artinya Edit 
            ...
            $this->load->view('karyawan/undangan-add', $data);
        ...
        //jika membawa ID, artinya Edit 
            ...
            $data['unit']= $this->Adminm->getAllData('unit');
            $data['ruangan']= $this->Adminm->getAllData('ruangan');
            $this->load->view('karyawan/undangan-edit', $data);
        }
    ...
    public function konfirmasi()
    {
        ...
        //jika membawa ID, artinya Edit 
            ...
            $this->load->view('karyawan/v_editkehadiran',$data);
        }
         public function editbahasan($id_undangan)
        {
            ...
            $detail = $this->Mundangan->detail_data($id_undangan);
            $data['data'] = $this->Mundangan->getkehadiran($id_undangan);
            $this->load->view('karyawan/v_editbahasan',$data);
        }
