...
<section class="content">
     ...
     <div class="box box-info">
            ...
            <form class="form-horizontal" action="<?php echo site_url('admin/hasil/upload') ;?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-footer">
                <a href="<?php echo site_url(); ?>/admin/hasil/" class="btn btn-danger" value="batal">Batal</a>
