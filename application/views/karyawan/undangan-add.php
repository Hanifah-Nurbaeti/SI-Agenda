  ...
  <section class="content container-fluid">
     <?php $msg = $this->session->flashdata('msg');?>
      ...
      <div class="alert alert-danger">
        <strong>Inputan Salah!</strong> Ruangan tidak bisa dipakai!.
      </div>
      <?php endif?>
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
          <div class="panel-body">
            ...
            <form role="form" class="form-horizontal form-groups-bordered" method="post" action="<?php echo site_url()?>/karyawan/undangan/add">
             <input type="hidden" name="id_undangan" value="<?php echo @$detail->id_undangan?>">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="nomor_undangan" value="<?php if (@$detail){ echo @$detail->nomor_undangan;} else { echo set_value('nomor_undangan');}?>">
                </div>
              </div>
