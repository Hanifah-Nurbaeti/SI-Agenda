  ...
  <table class="table table-bordered datatable" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr class=" odd gradeX">
                                    ...
                                    <td>
          <a onclick="javascript: return confirm ('anda yakin mau mengubah data?')" href="<?php echo site_url()?>/karyawan/undangan/add/<?php echo $row->id_undangan?>" class= "fa fa-edit"></a> |
