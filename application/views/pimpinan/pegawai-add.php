<?php $this->load->view('pimpinan/header.php')?>
  ...
  <section class="content container-fluid">
      ...
      <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
          <div class="panel-body">
            ...
            <form role="form" class="form-horizontal form-groups-bordered" method="post" action="<?php echo site_url()?>/pimpinan/pegawai/add">
              ...
              <div class="form-group">
      <label class="control-label col-sm-3" for="thn">Username:</label>
      <div class="col-sm-5">
    ...
    <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="email" class="form-control" name="alamat_email" value="<?php if (@$detail){ echo @$detail->alamat_email;} else { echo set_value('alamat_email');}?>">
                </div>
              </div>
 ...
 <?= form_open_multipart('pimpinan/pegawai/edit'); ?>