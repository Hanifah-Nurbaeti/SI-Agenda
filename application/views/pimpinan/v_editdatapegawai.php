...
<div class="content-wrapper">
    ...
    <section class="content">
     ...
     <div class="box box-info">
           ...
           ?>
            <form class="form-horizontal" action="<?php echo site_url('pimpinan/pegawai/update') ;?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-footer">
                <a href="<?php echo site_url(); ?>/pimpinan/pegawai" class="btn btn-danger" value="batal">Batal</a>
