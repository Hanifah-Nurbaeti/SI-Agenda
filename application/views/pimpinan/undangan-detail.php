...
<div class = "content-wrapper">
	<section class="content">
		...
		<a href="<?php echo site_url()?>/pimpinan/undangan/index/<?php echo $detail->id_undangan?>" class= "btn btn-success">Kembali</a>
		<a href="<?php echo site_url()?>/pimpinan/undangan/pdf/<?php echo $detail->id_undangan?>" class= "btn btn-warning">Eksport Pdf</a>
